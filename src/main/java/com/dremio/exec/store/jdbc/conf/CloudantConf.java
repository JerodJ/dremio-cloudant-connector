...
@SourceType(value = "CloudantARP", label = "Cloudant",uiConfig = "cloudant-layout.json")
public class CloudantConf extends AbstractArpConf<CloudantConf> {
  private static final String ARP_FILENAME = "arp/implementation/cloudant-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.cloudant.CloudantDriver";
